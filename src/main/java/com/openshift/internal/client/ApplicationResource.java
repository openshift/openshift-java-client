...
public class ApplicationResource extends AbstractOpenShiftResource implements IApplication {
	...
	public List<IEmbeddedCartridge> addEmbeddableCartridge(ICartridgeConstraint<IEmbeddableCartridge> cartridgeConstraint) throws OpenShiftException {
		Collection<IEmbeddableCartridge> cartridges = cartridgeConstraint.getMatching(getConnection().getEmbeddableCartridges());
	...
	public Collection<IEmbeddedCartridge> getEmbeddedCartridges(ICartridgeConstraint<IEmbeddedCartridge> constraint) throws OpenShiftException {
	...
	public void removeEmbeddedCartridges(ICartridgeConstraint<IEmbeddableCartridge> cartridgeConstraint) throws OpenShiftException {
