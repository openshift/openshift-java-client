 ...
 */
public class LatestVersionOfName<C extends IEmbeddableCartridge> extends AbstractCartridgeConstraint<C> {
	...
	protected boolean matches(C cartridge) {
		return cartridge.getName().startsWith(nameConstraint);
	}

	@Override
	public List<C> getMatching(Collection<C> cartridges) {
		return Collections.singletonList(getLatest(super.getMatching(cartridges)));
	}
	
	protected C getLatest(List<C> matchingCartridges) {
	...
	public boolean equals(Object obj) {
		...
		LatestVersionOfName<C> other = (LatestVersionOfName<C>) obj;
