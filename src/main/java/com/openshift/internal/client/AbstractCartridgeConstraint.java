 ...
 */
public abstract class AbstractCartridgeConstraint<C extends IEmbeddableCartridge> implements ICartridgeConstraint<C> {
	...
	protected abstract boolean matches(C cartridge);
}
