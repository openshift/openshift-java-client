...
public interface IApplication extends IOpenShiftResource {
	 ...
	 */
	public List<IEmbeddedCartridge> addEmbeddableCartridge(ICartridgeConstraint<IEmbeddableCartridge> cartridgeConstraint)
	 ...
	 */
	public void removeEmbeddedCartridges(ICartridgeConstraint<IEmbeddableCartridge> cartridgeConstraint)
			throws OpenShiftException;
